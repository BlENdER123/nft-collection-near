...
function Header() {
	...
	const walletAddress = useSelector(
		(state) => state.appReducer.account.accountId,
	);
			...
			<div className="header header2">
				<div className="container-header">
					<div className="acc-info">
							...
							{localStorage.undefined_wallet_auth_key ? (
								<div className="wallet">
									...
									<div className={openMenu ? "menu-info" : "hide"}>
										...
										<a className={"hoverMenuItems"} onClick={logOut}>
											Log out
										</a>
									</div>
						...
						<div className="pages">
							<Link to="/">
								<div className={`page-element ${linkIsActive("/")}`}>Home</div>
							</Link>
							<Link to="/load-nft">
								<div
									className={`page-element ${linkIsActive(
										"/load-nft",
									)} ${linkIsActive("/nft-customization")} ${linkIsActive(
										"/nft-generate",
									)} ${linkIsActive("/nft-collection")}`}
								>
									Collection Editor
								</div>
							</Link>
							<Link to="/nft-market">
								<div className={`page-element ${linkIsActive("/nft-market")}`}>
									Marketplace
								</div>
							</Link>
							{/* <Link to="/how">
                ...
                >
                  FAQ
						...
						<div className={mobMenu ? "pages-m pages-m-active" : "pages-m"}>
							...
							<Link to="/load-nft">
								<div className={`page-element ${linkIsActive("/load-nft")}`}>
