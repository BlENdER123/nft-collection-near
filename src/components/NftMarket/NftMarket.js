...
//ПРАВИЛЬНО ПОСЧИТАТЬ
    ...
    if (totalFetched === totalLength) {
      console.log("finished", "totalFetched", totalLength, "totalLength", totalLength)
      setHasMore(false);
    } else {
      ...
      for (let i = totalFetched; i < totalFetched + uploadCount; i++) {
        ...
        console.log("totalLength", totalLength, "totalFetched", totalFetched, "uploadCount", uploadCount, "out", out)
      ...
      <div className="constructor-market">
        <div className="container-header">
          <div className="modal-constructor modal-constructor-filter">
            <div onClick={() => handleCheck()} className="title-1">Marketplace
            </div>
          ...
          {props.loader ?
            <Loader/>
            : NFTsUrlsError ? <Retry/> :
              <div id={"scrollableDiv"} className="modal-constructor modal-constructor-market">
                <InfiniteScroll
                  ...
                  hasMore={hasMore}
                  loader={
                    <div style={{width: "100%", display: "flex", paddingTop: "200px"}}>
                      ...
                      .map((item, index) => {
                        return (
                          ...
                          >
                            ...
                            <div
                              className="collection_name">{item.name.substring(0, 20)}</div>
                            <div className="collection_subtitle">Price</div>
                            <div className="collection_price">
                                                            <span
                                                              className="collection_price_span"/> {item.price.toFixed(3)} NEAR
                            </div>
                          </div>
                        );
                      })
